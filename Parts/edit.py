...
def editing(event=None):
    ...
    edit_button.grid(row=12, column=1, columnspan=2, pady=5, padx=5, ipadx=80)
    # --------------------------------Autofill button ------------------------------
    fill = "Auto Complete Based on Model Name (control+a)"
    fill_button = Button(editor, text=fill, command=edit_autofill)
    fill_button.grid(row=12, column=3, columnspan=2, pady=5, padx=5, ipadx=45)
    # -------------------------------Key Bindings ----------------------------------
