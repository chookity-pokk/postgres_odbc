...
def autofill():
    if model.get() == "GD-1.5H" or "gd-1.5h":
    ...
    elif model.get() == "GD-10H" or "gd-10h":
    ...
    elif model.get() == "GD-13.5H" or "gd-13.5h":
        dimensions.insert(0, "48x73x57")
        frame.insert(0, "Powder Coated Steel")
        housing.insert(0, "Powder Coated Aluminum")
        tank_size.insert(0, 110)
    ...
    elif model.get() == "GD-5x5H" or "gd-5x5h":
    ...
    elif model.get() == "GD-7x7H" or "gd-7x7h":
        dimensions.insert(0, "48x84x62")
        frame.insert(0, "Powder Coated Steel")
        housing.insert(0, "Powder Coated Aluminum")
        tank_size.insert(0, 115)
    ...
    elif model.get() == "GD-20H" or "gd-20h":
    ...
    elif model.get() == "GD-27H" or "gd-27h":
        dimensions.insert(0, "48x120x81")
        frame.insert(0, "Powder Coated Steel")
        housing.insert(0, "Powder Coated Aluminum")
        tank_size.insert(0, 230)
